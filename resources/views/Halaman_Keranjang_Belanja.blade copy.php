                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="image-prod">
                                            <img src="{{ asset('image-barang/' . $row->options->gambar_barang) }}" alt="" height=70px>
                                        </td>
                                        ...
                                        @if($row->options->id_kategori_barang == 1 || $row->options->id_kategori_barang == 2)
                                        <td class="keterangan_pesanan">
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="9" placeholder="Dingin Atau Panas ? Masukkan Keterangan nya Disini" name="keterangan_pesanan"></textarea>
                                        </td>
                                        @else
                                        <td class="keterangan_pesanan">
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="9" placeholder="Masukkan Keterangan Pesanan Anda Disini Jika Ada" name="keterangan_pesanan"></textarea>
                                        </td>
                                        @endif
                                        ...
                                        <td class="total">Rp. {{ preg_replace('/0+$/', '', $row->subtotal()) }}</td>
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-8 ftco-animate mt-5">
                        ...
                        <div class="row align-items-end">
                            <div class="col-md-12">
                                <input type="hidden" name="total_bayar" value="{{ preg_replace('/0+$/', '', Cart::subtotal())  }}">
                    ...
                    <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                        <div class="cart-total mb-3">
                            ...
                            <p class="d-flex">
                                <span>SubTotal</span>
                                <span>Rp. {{ preg_replace('/0+$/', '', Cart::subtotal()) }}</span>
                            </p>
                            <hr>
