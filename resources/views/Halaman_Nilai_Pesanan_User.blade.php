            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        <h1 class="mb-3 mt-5 bread">Nilai Pesanan</h1>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 ftco-animate mt-5">
                    <form action="/postnilaipesanan/{{ $datapsn->no_order }}" method="post" enctype="multipart/form-data" class="billing-form ftco-bg-dark p-3 p-md-5">
                        @csrf

                        <h3 class="mb-4 billing-heading">Nilai Pesanan</h3>
                        <div class="row align-items-end">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="penilaian_barang" placeholder="Masukkan Penilaian Anda Disini" id="floatingTextarea"></textarea>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-white p-2">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
