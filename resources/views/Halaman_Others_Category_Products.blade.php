        ...
        <div class="slider-item" style="background-image: url(coffe-template/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    @else
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        <h1 class="mb-3 mt-5 bread">Category : {{ $dataothers->name_category }} </h1>
                    </div>
                    @endif
                    @endif
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 ftco-animate">
                    <div class="sidebar-box">
                        <form action="/otherscategoryproducts/{{ $dataothers->name_category_slug }}" class="search-form">
                    ...
                    <div class="row">
                        @foreach($dataotherscategoryproducts as $dtothctrprdcts)
                        <div class="col-md-4">
                            <div class="menu-entry">
                                <a href="/detailsproducts/{{ $dtothctrprdcts->name_category_slug }}"><img src="{{ asset('image-barang/' . $dtothctrprdcts->image_category) }}" alt="" class="img-fluid img" data-aos="flip-left" data-aos-duration="1000" width="400px"></a>
                                <div class="text text-center pt-4">
                                    <h3><a href="/detailsproducts/{{ $dtothctrprdcts->name_category_slug }}">{{ $dtothctrprdcts->name_category }}</a></h3>
                                    @if($dtothctrprdcts->id_kategori == 1)
                                    <p>Category : Coffee</p>
                                    @elseif($dtothctrprdcts->id_kategori == 2)
                                    <p>Category : Drip Coffee</p>
                                    @elseif($dtothctrprdcts->id_kategori == 3)
                                    <p>Category : Grinders</p>
                                    @elseif($dtothctrprdcts->id_kategori == 4)
                                    <p>Category : Coffee Machines</p>
                                    @elseif($dtothctrprdcts->id_kategori == 5)
                                    <p>Category : Manual Brewers</p>
                                    @elseif($dtothctrprdcts->id_kategori == 6)
                                    <p>Category : Coffee Tools</p>
                                    @endif
                                    <p><a href="/detailsproducts/{{ $dtothctrprdcts->name_category_slug }}" class="btn btn-primary btn-outline-primary">Lihat Semua Produk</a></p>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        {{ $dataotherscategoryproducts->links() }}
                    </div>
