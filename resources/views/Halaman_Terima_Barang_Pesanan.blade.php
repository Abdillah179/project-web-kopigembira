            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        <h1 class="mb-3 mt-5 bread">Terima Barang</h1>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 ftco-animate mt-5">
                    <form action="/postterimabarang/{{ $data->no_order }}" method="post" enctype="multipart/form-data" class="billing-form ftco-bg-dark p-3 p-md-5">
                        @csrf

                        <h3 class="mb-4 billing-heading">Terima Barang</h3>
                        <div class="row align-items-end">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="firstname">Foto</label>
                                    <input type="file" class="form-control" name="bukti_diterima">
                                </div>
                            </div>
